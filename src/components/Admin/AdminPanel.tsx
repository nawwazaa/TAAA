...
const AdminPanel: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${isRTL ? 'rtl' : 'ltr'} overflow-x-hidden`}>
      <div className="flex flex-col lg:flex-row">
        {/* Admin Sidebar */}
        <div className="w-full lg:w-64 bg-white shadow-lg border-r border-gray-200 lg:min-h-screen">
                ...
                {adminSections.map((section) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-shrink-0 flex flex-col items-center px-3 py-2 rounded-lg text-center transition-all duration-200 min-w-[100px] ${
                        isActive
                    ...
                    >
                      ...
                      <span className="text-xs font-medium text-center leading-tight">{section.label.split(' ')[0]}</span>
                    </button>
                  );
                })}
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl md:text-3xl font-bold text-gray-900">12,450</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl md:text-3xl font-bold text-gray-900">$45,230</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl md:text-3xl font-bold text-gray-900">15</p>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
          <button 
            ...
            className="bg-blue-100 hover:bg-blue-200 text-blue-800 p-3 md:p-4 rounded-lg text-center transition-colors"
          >
            <Search className="w-6 h-6 md:w-8 md:h-8 mx-auto mb-2" />
            <span className="text-sm md:text-base font-medium">Search Users</span>
          </button>
          <button 
            onClick={() => setActiveSection('role-management')}
            className="bg-purple-100 hover:bg-purple-200 text-purple-800 p-3 md:p-4 rounded-lg text-center transition-colors"
          >
            <Crown className="w-6 h-6 md:w-8 md:h-8 mx-auto mb-2" />
            <span className="text-sm md:text-base font-medium">Manage Roles</span>
          </button>
          <button 
            onClick={() => setActiveSection('tournaments')}
            className="bg-green-100 hover:bg-green-200 text-green-800 p-3 md:p-4 rounded-lg text-center transition-colors"
          >
          ...
          <button 
            ...
            className="bg-orange-100 hover:bg-orange-200 text-orange-800 p-3 md:p-4 rounded-lg text-center transition-colors"
          >
            <DollarSign className="w-6 h-6 md:w-8 md:h-8 mx-auto mb-2" />
            <span className="text-sm md:text-base font-medium">Transactions</span>
          </button>
        </div>
      </div>
    </div>
