      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="border-b border-gray-200">
          <nav className="flex space-x-0 rtl:space-x-reverse overflow-x-auto">
            ...
            >
              <Wallet className="responsive-tab-icon w-5 h-5" />
              <span className="responsive-tab-text-full font-medium">Dashboard</span>
              <span className="responsive-tab-text-short font-medium">Dashboard</span>
            </button>
            ...
            >
              <ArrowUpDown className="responsive-tab-icon w-5 h-5" />
              <span className="responsive-tab-text-full font-medium">Buy & Sell</span>
              <span className="responsive-tab-text-short font-medium">Buy & Sell</span>
            </button>
            ...
            >
              ...
              <span className="responsive-tab-text-full font-medium">Rewards</span>
              <span className="responsive-tab-text-short font-medium">Rewards</span>
            </button>
